...
void UGrabber::SetupInputComponent() {
	...
	if (InputComponent) {
		UE_LOG(LogTemp, Error, TEXT("Input componentn found"), *GetOwner()->GetName())
			// bind the input axis
...
const FHitResult UGrabber::GetFirstPhysicsBodyInReach()
{
	...
	if (ActorHit) {
		UE_LOG(LogTemp, Warning, TEXT("Line trace hit: %ts"), *(ActorHit->GetName()))
	}
	return Hit;
}